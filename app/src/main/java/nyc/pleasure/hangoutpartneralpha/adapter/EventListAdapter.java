...
import nyc.pleasure.hangoutpartneralpha.obj.Event;
...
public class EventListAdapter  extends FirebaseListAdapter<Event> {
    ...
    /**
     * Bind an instance of the <code>Event</code> class to our view. This method is called by <code>FirebaseListAdapter</code>
     * when there is a data change, and we are given an instance of a View that corresponds to the layout that we passed
     * to the constructor, as well as a single <code>Event</code> instance that represents the current data to bind.
     *
